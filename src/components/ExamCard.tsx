...
export const ExamCard: React.FC<ExamCardProps> = ({ exam }) => {
  return (
      <Link to={`/exam/${exam.id}`} className="block transform transition-transform hover:scale-105">
          ...
          <div className="p-6">
            ...
            <div className="space-y-2 mb-4">
              ...
              <div className="flex items-center text-sm text-gray-500">
                ...
                <span className="font-medium">{exam.unit}</span>
              </div>
              <div className="flex items-center text-sm text-gray-500">
              ...
              <div className="flex items-center text-sm text-gray-500">
                ...
                <span className="font-medium">Updated {exam.lastUpdated}</span>
              </div>
            </div>
            <div className="flex items-center justify-between mt-4">
              <span className="text-sm text-gray-500">{exam.instructor}</span>
